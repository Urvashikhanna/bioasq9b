# bioasq9b
Download our pre-processed version of BioASQ 9b training  and Test Batch 5 dataset (BioASQ-task9bPhaseB-testset5_squadformat.json), and place them in the data_dir folder. 
