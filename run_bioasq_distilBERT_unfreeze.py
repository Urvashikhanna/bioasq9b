...
args = {
    ...
    'eval_batch_size': 3,
    'do_lower_case' : False,
    'train_file':'BioASQ_final_snippet-annotated_trainingdata_9b.json',
    'predict_file':'BioASQ-task9bPhaseB-testset5_squadformat.json',
...
def evaluation_bioasq(args1):
    ...
    os.system(cmd1)
    path2_to=os.path.join(args1.prediction_dir,"7B5_golden.json")
    print("path2_to",path2_to)
    shutil.copy("/BioBERT/BioBERT-PyTorch/7B5_golden.json", path_to)
